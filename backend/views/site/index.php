...
<div class="site-index">
    ...
    <div class="jumbotron">
        ...
        <p><a class="btn btn-lg btn-success" href="index/php?r=user">Daftar User</a></p>
        <p><a class="btn btn-lg btn-success" href="index/php?r=distribusi-pangan">Mendata Distribusi Pangan</a></p>
    </div>
