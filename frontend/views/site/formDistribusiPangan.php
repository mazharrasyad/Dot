...
<div class="site-formDistribusiPangan">
  ...
  <h1><?= Html::encode($this->title) ?></h1>
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <?= $form->field($model, 'satuan_stok')->hint('Contoh : Kilogram')->label('Satuan Stok Bahan Pangan')->radioList(array('Ton' => 'Ton', 'Kwintal' => 'Kwintal', 'Kilogram' => 'Kilogram', 'Gram' => 'Gram', 'Ons' => 'Ons', 'Liter' => 'Liter')) ?>
